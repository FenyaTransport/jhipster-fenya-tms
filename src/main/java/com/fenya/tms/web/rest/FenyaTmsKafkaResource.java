...
@RestController
@RequestMapping("/api/fenya-tms-kafka")
public class FenyaTmsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FenyaTmsKafkaResource.class);
    ...
    public FenyaTmsKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
